  ...
  function runHyphenTest() {
    ...
    function test_hyphens_find(delimiter) {
      try {
        ...
        try {
          if (_globalThis.find) {
            result = _globalThis.find(testword + testword);
          } else {
            textrange = _globalThis.self.document.body.createTextRange();
...
export default {
  csshyphens: createAsyncTestListener("csshyphens"),
  softhyphens: createAsyncTestListener("softhyphens"),
  softhyphensfind: createAsyncTestListener("softhyphensfind")
}
