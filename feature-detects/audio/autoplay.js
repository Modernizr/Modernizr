/*!
 ...
 !*/
/* DOC
 Checks for support of autoplay/asyncplay of the audio element.
 */
define(['Modernizr', 'addTest', 'docElement', 'createElement', 'test/audio'], function(Modernizr, addTest, docElement, createElement) {
	...
	Modernizr.addAsyncTest(function() {
		...
		var cleanUp = function() {
			elem.removeEventListener('play', playListener);
			elem.removeEventListener('loadedmetadata', loadedmetadataListener);
		...
		var loadedmetadataListener = function() {
			...
			addTest('audioautoplay', canautoplay);
			cleanUp();
		};
		...
		elem.addEventListener('play', playListener);
		elem.addEventListener('loadedmetadata', loadedmetadataListener);

		// wait for the next tick to play, otherwise the listener may
		// not have time to be added in high load situations (e.g. the test suite)
		setTimeout(function() {
			elem.load();
			elem.play();

			// iOS 7 blocks all media events (>=8 is ok), in cases like this,
			// wait a while and then report audioautoplay doesn't work
			setTimeout(function() {
				tookTooLong();
			}, 1000);
		}, 0);
