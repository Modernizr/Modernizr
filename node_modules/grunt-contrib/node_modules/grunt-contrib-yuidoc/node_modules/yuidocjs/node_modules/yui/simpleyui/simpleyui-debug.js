...
}, '3.8.0pr1', {"use": ["get", "features", "intl-base", "yui-log", "yui-later"]});
...
YUI.add('yui', function (Y, NAME) {}, '3.8.0pr1', {"use": ["get", "features", "intl-base", "yui-log", "yui-later"]});
...
}, '3.8.0pr1', {"requires": ["selector-native"]});
...
}, '3.8.0pr1', {"requires": ["dom-core", "selector"]});
...
}, '3.8.0pr1', {"requires": ["event-custom-base", "querystring-stringify-simple"]});
...
}, '3.8.0pr1', {"use": ["yui", "oop", "dom", "event-custom-base", "event-base", "pluginhost", "node", "event-delegate", "io-base", "json-parse", "transition", "selector-css3", "dom-style-ie", "querystring-stringify-simple"]});
var Y = YUI().use('*');
